export default function ArchitectSkeleton() {
  return (
    <div className="bg-surface rounded-2xl border border-border p-6 shadow-card flex flex-col justify-between h-full space-y-4">
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="h-3 skeleton w-1/3 rounded-md mt-1" />
        </div>
      </div>
      
      <div className="space-y-2 pt-2 border-t border-border/60">
        <div className="h-3.5 skeleton w-full rounded-md" />
        <div className="h-3.5 skeleton w-5/6 rounded-md" />
      </div>
